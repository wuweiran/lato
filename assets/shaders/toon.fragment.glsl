...
//	vec4 color = texture2D(u_texture, a_texCoord0);
	float factor = toonify(max(gl_FragColor.r, max(gl_FragColor.g, gl_FragColor.b)));
	gl_FragColor = vec4(factor*gl_FragColor.rgb, gl_FragColor.a);
